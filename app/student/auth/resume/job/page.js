"use client"
import { asyncresumeaddjobstudent } from '@/store/actions/studentActions'
...
const [description, setdescription] = useState('')
    ...
    const addHandler = ()=>{
        ...
        dispatch(asyncresumeaddjobstudent(job));
...
export default page
{/* <button onClick={addHandler} className='btn btn-primary'> Add Job</button> */}